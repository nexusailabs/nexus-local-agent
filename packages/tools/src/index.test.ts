...
const node: NodeSpec = { id:'z13', baseUrl:'http://z13:7790', platform:'linux-x64', memoryGb:64, capabilities:['exec','fs','git','code','browser'], reachability:'lan', tags:[], executionClass:90, reliabilityClass:90, models:[] };
